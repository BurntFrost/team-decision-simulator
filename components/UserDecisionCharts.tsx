...
import { famousPeopleByMBTI, harryPotterHousesByMBTI, hogwartsHouseInfo, getMBTIColor, getMBTIDescription, getRandomFamousPerson, getHarryPotterHouse, getHouseColor, groupResultsByHogwartsHouses } from "@/lib/mbtiData";
  ...
  return (
    ...
    >
      <div className="w-full max-w-full overflow-hidden">
        <TabsList className="w-full mb-4 bg-gray-100 p-1 rounded-xl overflow-hidden grid grid-cols-2 sm:grid-cols-4 gap-1">
          <TabsTrigger
            value="bar"
            className="rounded-lg font-medium text-xs sm:text-sm py-1.5 data-[state=active]:bg-white data-[state=active]:text-indigo-600 data-[state=active]:shadow-sm text-gray-600 transition-all duration-200"
          >
            Confidence
          </TabsTrigger>
          <TabsTrigger
